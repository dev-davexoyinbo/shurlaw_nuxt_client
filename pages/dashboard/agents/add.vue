						...
						<div class="col-lg-12 col-md-12">
							...
							<form ref="form" @submit.prevent="submit" class="submit-page">
								...
								<div class="form-submit">	
									...
									<div class="submit-section">
										<div class="form-row">
											...
											<div class="form-group col-md-12">
												<label>Full Name<a href="#" class="tip-topdata" data-tip="Property Title"><i class="ti-help"></i></a></label>
												<input  required type="text" class="form-control" name="name">
											</div>

											<div class="form-group col-md-6">
												<label>Profile Photo</label>
												<input required type="file" accept="image/*" class="form-control" name="profile_photo">
											</div>
											...
											<div class="form-group col-md-12">
												...
												<textarea required class="form-control h-120" name="about"></textarea>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="submit-section">
										<div class="form-row">
											...
											<div class="form-group col-md-4">
												...
												<input type="password" required class="form-control" name="password" v-model="password">
											</div>
											
											<div class="form-group col-md-4">
												<label>Password Confirmation</label>
												<input type="password" required class="form-control" v-model="passwordConfirmation">
												<small class="text-danger" v-if="password && (password != passswordConfirmation)">Passwords do not match.</small>
											</div>
								...
								<div class="form-group col-lg-12 col-md-12">
									...
									<ul class="no-ul-list">
										<li>
											<input required id="aj-1" class="checkbox-custom" name="aj-1" type="checkbox">
